...
* **test:** point the vitest @ alias at the repo root, so the suite stops collecting zero tests ([#86](https://github.com/forbiddenlink/contradict-me/issues/86)) ([e8cde4a](https://github.com/forbiddenlink/contradict-me/commit/e8cde4a9a4fc895286fa630dfc1054eba579b297))
...
* add missing posthog-node dep and ESM next-sitemap config ([a426d85](https://github.com/forbiddenlink/contradict-me/commit/a426d85007046b1a192df0c67e95f3d98751edc9))
...
* cap cookie override below v2 to prevent @supabase/ssr build break ([8d08db6](https://github.com/forbiddenlink/contradict-me/commit/8d08db6ca3701d4cfefd687b1813a9191db6d269))
* **ci:** resolve pnpm version conflict blocking CI ([#38](https://github.com/forbiddenlink/contradict-me/issues/38)) ([03577eb](https://github.com/forbiddenlink/contradict-me/commit/03577eb90b8a3a1488caefcc234b5e33f3b060ee))
...
* **deps:** patch CRITICAL shell-quote vuln via pnpm override ([36a3a55](https://github.com/forbiddenlink/contradict-me/commit/36a3a5529715de6bb554c7c21c34d3dbbeab7817))
* **deps:** pin @eslint/js to ^9.x and add packageManager field to restore Vercel builds ([d75725c](https://github.com/forbiddenlink/contradict-me/commit/d75725c0e6ee1aeb6c5a31348bb8adde917aa9b1))
...
* patch 4 security vulnerabilities ([b645224](https://github.com/forbiddenlink/contradict-me/commit/b645224325bb0f5f3390088853ccc8d93cf902fc))
...
* **security:** pin transitive deps to patched versions (high alerts) ([7d00aad](https://github.com/forbiddenlink/contradict-me/commit/7d00aadb288d7ed75f599771bf878d796e64260b))
